import aop.tx.com.chencan.dao.EmpDao;
import aop.tx.com.chencan.entity.Emp;
...
public class SpringAOPAnnotaitonTxTest {
    public class MyTest {

        ClassPathXmlApplicationContext context =   new ClassPathXmlApplicationContext("springaopannotationtx.xml");
        @Test
